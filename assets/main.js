...
(function() {
	...
	// Initialize "On Visible" animations.
		...
		onvisible.add('#text04', { style: 'fade-up', speed: 1000, intensity: 0, threshold: 3, delay: 0, replay: false });
		onvisible.add('#container01', { style: 'fade-up', speed: 1250, intensity: 1, threshold: 3, delay: 0, replay: false });
		onvisible.add('#text05', { style: 'fade-up', speed: 1000, intensity: 0, threshold: 3, delay: 0, replay: false });
